...
// include: C:\Users\Tshepo\AppData\Local\Temp\tmpyue_w1ok.js
  ...
  (() => {
    ...
    loadPackage({"files": [{"filename": "/DejaVuSansMono.ttf", "start": 0, "end": 335068}], "remote_package_size": 335068});

  })();

// end include: C:\Users\Tshepo\AppData\Local\Temp\tmpyue_w1ok.js
// include: C:\Users\Tshepo\AppData\Local\Temp\tmp8ke7edti.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Tshepo\AppData\Local\Temp\tmp8ke7edti.js
// include: C:\Users\Tshepo\AppData\Local\Temp\tmp4x5lkypl.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Tshepo\AppData\Local\Temp\tmp4x5lkypl.js
...
var ASM_CONSTS = {
 ...
 369710: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 369793: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 369862: () => { return window.innerWidth; },  
 369892: () => { return window.innerHeight; }
};
